...
function CartOverview() {
  ...
  return (
    <div className="rou flex items-center justify-between rounded-t-lg bg-stone-800 px-4 py-5 uppercase text-stone-200 drop-shadow-md sm:px-6 sm:drop-shadow-none">
